                        ...
                        <ul className="list-group" style={{ marginLeft: "5px" }}>
                            {
                                dashSidebarOpts.map((item, index) =>
                                    <li id="sidebarTexts" onClick={() => sidebarClick(item, index)}
                                        className={activeStep === item.name ? 'hamburger sidebar-texts F custom-list-group-item border-0 d-flex align-items-center mb-2' : 'mb-2 hamburger sidebar-texts sidebar-inactive-tab custom-list-group-item border-0 d-flex align-items-center'}
                                ...
                                <div className="cols-sm-12 p-3 col-md-9">
                                    <div className="row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 mb-3">
                                            <label for="formFileSm" className="formLables form-label">Old Password</label>
                                            <input class="form-control form-control-sm" value="" id="formFileSm" type="text" />
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-lg-12 mb-3">
                                            <label for="formFileSm" className="formLables form-label">New Password</label>
                                            <input class="form-control form-control-sm" value="" id="formFileSm" type="email" />
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-lg-12 mb-3">
                                            <label for="formFileSm" className="formLables form-label">Confirm Password</label>
                                            <input class="form-control form-control-sm" value="" id="formFileSm" type="number" />
                                        </div>
