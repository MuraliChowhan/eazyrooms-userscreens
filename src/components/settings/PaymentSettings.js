                        ...
                        <div style={{ height: "550px", overflow: "auto" }}>
                            <div className="row mx-2 bg-light">
                                ...
                                <div className="cols-sm-12 p-3 col-md-9">
                                    <div className="row">
                                        <div className="">
                                            <div className="headings-text">Stripe</div>
                                            <div className="form-check form-switch col-sm-12 col-md-6 col-lg-6 mb-3">
                                            ...
                                            <div className="col-sm-12 col-md-6 col-lg-6 mb-3">
                                                <label for="formFileSm" className="formLables form-label">Paypal mode</label>
                                                <input className="form-control form-control-sm" id="formFileSm" type="text" />
                                            </div>
                                            <div className="col-sm-12 col-md-6 col-lg-6 mb-3">
                                                <label for="formFileSm" className="formLables form-label">Paypal Account</label>
                                                <input className="form-control form-control-sm" id="formFileSm" type="text" />
                                            </div>
                                        </div>
                                        <div className="">
                                            <div className="headings-text">Paypal</div>
                                            <div className="form-check form-switch">
                                                <input className="form-check-input" type="checkbox" id="flexSwitchCheckChecked" checked />
                                            </div>
                                            <div className="col-sm-12 col-md-6 col-lg-6 mb-3">
                                                <label for="formFileSm" className="formLables form-label">Stripe Account</label>
                                                <input className="form-control form-control-sm" id="formFileSm" type="text" />
                                            </div>
                                            <div className="col-sm-12 col-md-6 col-lg-6 mb-3">
                                                <label for="formFileSm" className="formLables form-label">Public Key</label>
                                                <input className="form-control form-control-sm" id="formFileSm" type="text" />
                                            </div>
                                            <div className="col-sm-12 col-md-6 col-lg-6 mb-3">
                                                <label for="formFileSm" className="formLables form-label">Secrete Key</label>
                                                <input className="form-control form-control-sm" id="formFileSm" type="text" />
                                            </div>
                                        </div>
