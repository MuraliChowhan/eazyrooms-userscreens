...
import ManageRoleModal from "../modals/ManageRolesModal";
...
function Roles() {
    ...
    const [roleModal, setRoleModal] = useState({ modal: false, type: '', action: '', modalType: '', details: {} });
    ...
    return (
        <>
                    ...
                    <div onClick={openNav}>
                        ...
                        <div style={{ height: "550px", overflow: "auto" }}>
                            <div className="row mx-2 bg-light">
                                ...
                                <div className="cols-sm-12 p-3 col-md-9 col-lg-9">
                                    <div className="p-3 rounded bg-white">
                                        <div className="d-flex justify-content-between mb-4">
                                            <div className="settings-each-tab-header">
                                                Manage Roles
                                            </div>

                                            <div className="bg-secondary rounded cursor-pointer p-2" style={{ color: "#fff", fontSize: "13px" }}
                                                onClick={() => setRoleModal({ modal: true, action: 'Edit', modalType: 'Edit', details: '' })}
                                            >
                                                Add New Role
                                            </div>
                                        </div>
                                        ...
                                        <div className="row mb-4">
                                            <div className="col-sm-12 col-md-6 col-lg-6">
                                                <div className="display-pages align-items-center text-center rounded w-75 p-1">
                                                    <span style={{ fontSize: "14px", color: "#fff" }}>Display</span>
                                                    <select style={{ fontSize: "14px", color: "#fff" }} id="disabledSelect" className="form-select-sm display-pages">
                                                        <option>50</option>
                                                        <option>30</option>
                                                        <option>20</option>
                                                    </select>
                                                    <span style={{ fontSize: "14px", color: "#fff" }}> Records per page</span>
                                                </div>
                                            </div>
                                            <div className="col-sm-12 col-md-6 col-lg-6">
                                                <Searchbar />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div className="d-flex">
                                                            <div className="bg-secondary" style={{ marginRight: "2px", padding: "5px", borderRadius: "15px", fontSize: "12px", color: "#fff" }}>
                                                                Update Profile
                                                            </div>
                                                            <div className="bg-secondary" style={{ marginRight: "2px", padding: "5px", borderRadius: "15px", fontSize: "12px", color: "#fff" }}>
                                                                Change Password
                                                    ...
                                                    <td>
                                                        <i className="pencil-icon-bg fas fa-pencil-alt text-white"></i>
            ...
            <ManageRoleModal
                ...
                onHide={() => setRoleModal({ modal: false, action: "Edit Property Details", modalType: 'Edit Property Details', type: 'Edit Property Details', details: {} })}
                params={roleModal}
            />
        </>
    );
