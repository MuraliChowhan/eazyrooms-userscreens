                                ...
                                <div className="cols-sm-12 p-3 col-md-9">
                                    ...
                                    <div className="row">
                                        <div class="col-sm-12 col-md-12 col-lg-12 mb-3">
                                            <label for="formFileSm" className="formLables form-label">Upload File</label>
                                            <input class="form-control form-control-sm" value="" id="formFileSm" type="file" />
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-lg-12 mb-3">
                                            <label for="formFileSm" className="formLables form-label">Name</label>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12 mb-3">
                                            <label for="formFileSm" className="formLables form-label">Phone</label>
