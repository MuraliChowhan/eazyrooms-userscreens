    ...
    return (
        <>
            <Modal
                ...
                className="custom-mo"
                keyboard={false}>
                <Modal.Header className="border-0 p-4 bg-transparent close-modal h5 mb-0" closeButton>
                    OTP Verification
                </Modal.Header>
                    ...
                    <div className="d-flex justify-content-center">
                        {
                            code?.toString().length >= 6 ?
                                <div
                                    ...
                                    className="col-12 mb-3 rounded mt-3 text-center mb-1 cursor-pointer OTP-custom-button-color">
                                    Submit
                                </div>
                                :
                                <div
