        ...
        <>
            ...
            <Accordion>
                <div className="accor bg-transparent">
                    <div className="chat-header-text cursor-pointer">Information</div>
                    <div className="body">Device</div>
                    <div className="body">Browser</div>
                </div>
                <div className="accor">
                    <div className="chat-header-text cursor-pointer">Client details</div>
                    <div className="body">
                ...
                <div className="accor">
                    <div className="chat-header-text cursor-pointer">History</div>
                    <div className="body">Lorem ipsum dolor sit amet.</div>
                </div>
                <div className="accor">
                    <div className="chat-header-text">Customer satisfaction</div>
                    <div className="body">Lorem ipsum dolor sit amet.</div>
                </div>
                <div className="accor">
                    <div className="chat-header-text cursor-pointer">Notes</div>
                    <div className="body">
